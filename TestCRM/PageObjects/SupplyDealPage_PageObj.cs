...
namespace Prj_test.PageObjects
{
    class SupplyDealPage_PageObj : NavigationBar_PageObj
    {
        ...
        private readonly By button_answers = By.XPath("//a[text()='Ответы']");
        ...
        public SupplyAnswerPage_PageObj go_to_answers()
        {
            _webDriver.FindElement(button_answers).Click();
            return new SupplyAnswerPage_PageObj(_webDriver);
        }
    }
}
